...
print"<a name='add' href='#add' onclick=\"window.open('tools.php?event=moresmiles','smiles','width=450,height=300,left=50,top=300,toolbar=0,status=0,border=0,scrollbars=1')\">Ещё смайлы</a></tr></td></table><br>* ПЕРЕД КАК НАПИСАТЬ ПОДУМАЙ А ТО БУДЕШЬ СИДЕТЬ В МЕНТОВКЕ </span></td>
...
<center><small>Powered by <a href="https://arz-host.xyz" title="сервера форума" class="copyright">ARZ Host</a> &copy; 1.1 UTF-8</small></center>
</body>
</html>