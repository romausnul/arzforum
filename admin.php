...
<center><small>Powered by <a href=\"arz-host.xyz\" title=\"Провайдер сайтов\" class='copyright'>СЕРВЕРА В НОРМЕ</a> &copy; 2.3 UTF-8<br></small></center></body></html>";
exit;}
...
<tr>
<td><a href="index.php">Форум ARZ HOST</a>
<br><div align=center>Вы вошли как <B><font color=red>ПРОЕКТОР МИРА(МАМОН)</font></B></td>
<td align="center" valign="middle"><span class="maintitle"><a href=admin.php><h3><font color=red>ТУТ РОМА ДЕЛАЕТ СВОЮ ПРОЕКЦИЮ<br></font> <?=$forum_name?></h3></a></span>
...
<td><b>Помощь</b><ul>
<li><a href="https://FORUM.ARZ-HOST.XYZ">ТУТ ФОРУМ</a>
<li><a href="https://FORUM.ARZ-HOST.XYZ/?66532">тут бан</a>
...
$k=$mmax; $mainr=""; // поиск название с помошью цикал
...
<SELECT name=kaksort>
<OPTION selected value=5>УБРАТЬ ВСЕХ ИЗ ОЧКА</OPTION>
<OPTION value=1>РЕДАКТИРОВАТЬ</OPTION>
<OPTION value=2>СКАЧАТЬ ДАННЫЕ</OPTION>
<OPTION value=3>ПЕРЕНЕСТИ ДАННЫЕ С ПАПКУ</OPTION>
>";


if ($error>0) print"$bada";

echo'* если что писать сюда romausnul@gmail.com';
}
}
...
?><br>
<center><font size=-2><small>Powered by <a href="https://arz-host.xyz" title="Скрипт форума" class="copyright">ARZ Host</a> &copy; 2.3 UTF-8<br></small></font></center>
</body>
</html>